...
export const Logo = styled.div`
  width: 41px;
  height: 41px;
  background: url(${x}) no-repeat center; /* Use the imported image as the background */
  background-size: cover; /* You can use "cover", "contain", or other values to control how the image is displayed */
